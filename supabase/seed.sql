...
values
  ...
  ((select id from public.profiles where username = 'sari_m'),
   ...
   'diverifikasi', now() - interval '1 day'),
  ...
  ((select id from public.profiles where username = 'agus_p'),
   ...
   'diverifikasi', now() - interval '2 days'),
  ...
  ((select id from public.profiles where username = 'dewi_k'),
   ...
   'diverifikasi', now() - interval '3 days'),
  ...
  ((select id from public.profiles where username = 'budi_s'),
   ...
   'dikerjakan', now() - interval '5 days'),
  ...
  ((select id from public.profiles where username = 'sari_m'),
   ...
   'dikerjakan', now() - interval '10 days'),
...
values
  ...
  ((select id from public.reports where judul like 'Gunungan sampah%'),
   'diverifikasi', 'Diverifikasi tim lingkungan kecamatan.', now() - interval '20 hours'),
  ...
  ((select id from public.reports where judul like 'Pos kamtib gelap gulita%'),
   'diverifikasi', 'Diverifikasi tim lingkungan kecamatan.', now() - interval '30 hours'),
  ((select id from public.reports where judul like 'Pos kamtib gelap gulita%'),
   'dikerjakan', 'Pengadaan lampu diproses oleh kelurahan.', now() - interval '20 hours'),
  ((select id from public.reports where judul like 'Pos kamtib gelap gulita%'),
   'selesai', 'Pengerjaan selesai — terima kasih warga.', now() - interval '10 hours'),
  ((select id from public.reports where judul like 'Lubang besar di tikungan dekat posyandu%'),
   'diverifikasi', 'Diverifikasi tim lingkungan kecamatan.', now() - interval '5 days'),
  ((select id from public.reports where judul like 'Lubang besar di tikungan dekat posyandu%'),
   'dikerjakan', 'Kontraktor penambalan masuk lokasi.', now() - interval '3 days'),
  ((select id from public.reports where judul like 'Lubang besar di tikungan dekat posyandu%'),
   'selesai', 'Pengerjaan selesai — terima kasih warga.', now() - interval '1 day'),
  ((select id from public.reports where judul like 'Taman sekolah butuh revitalisasi%'),
   'diverifikasi', 'Diverifikasi tim lingkungan kecamatan.', now() - interval '7 days'),
  ((select id from public.reports where judul like 'Taman sekolah butuh revitalisasi%'),
   'dikerjakan', 'Koordinasi dengan pihak sekolah selesai.', now() - interval '5 days'),
  ((select id from public.reports where judul like 'Taman sekolah butuh revitalisasi%'),
   'selesai', 'Revitalisasi rampung, tanaman dirawat rutin.', now() - interval '3 days'),
  -- ditolak
